...
public:
    ...
    void incrementCurrentFirstTimeDerivative(const double &value);

    void incrementCurrentSecondTimeDerivative(const double &value);
    ...
    void setConstrained(const bool &isConstrained);
