...
void ParametricSurfaceElement::getShapeFunctionsSecondDerivatives(double *xsi, double **&d2phi_dxsi2) const
{
    ...
    case PartitionOfUnity::T3:
        ...
        break;
    /*case PartitionOfUnity::T6:
        d2phi_dxsi2[0][0] = 4.0 * xsi1 - 1.0;
        d2phi_dxsi2[0][1] = 0.0;
        d2phi_dxsi2[0][2] = 4.0 * xsi2 + 4.0 * xsi1 - 3.0;
        d2phi_dxsi2[0][3] = 4.0 * xsi2;
        d2phi_dxsi2[0][4] = -4.0 * xsi2;
        d2phi_dxsi2[0][5] = -4.0 * (xsi2 + 2.0 * xsi1 - 1.0);

        d2phi_dxsi2[1][0] = 0.0;
        d2phi_dxsi2[1][1] = 4.0 * xsi2 - 1.0;
        d2phi_dxsi2[1][2] = 4.0 * xsi2 + 4.0 * xsi1 - 3.0;
        d2phi_dxsi2[1][3] = 4.0 * xsi1;
        d2phi_dxsi2[1][4] = -4.0 * (2.0 * xsi2 + xsi1 - 1.0);
        d2phi_dxsi2[1][5] = -4.0 * xsi1;
        break;
    case PartitionOfUnity::T10:
        d2phi_dxsi2[0][0] = (27.0 * xsi1 * xsi1 - 18.0 * xsi1 + 2.0) / 2.0;
        d2phi_dxsi2[0][1] = 0.0;
        d2phi_dxsi2[0][2] = -(27.0 * xsi2 * xsi2 + 54.0 * xsi1 * xsi2 - 36.0 * xsi2 + 27.0 * xsi1 * xsi1 - 36.0 * xsi1 + 11.0) / 2.0;
        d2phi_dxsi2[0][3] = (9.0 * xsi2 * (6.0 * xsi1 - 1.0)) / 2.0;
        d2phi_dxsi2[0][4] = (9.0 * xsi2 * (3.0 * xsi2 - 1.0)) / 2.0;
        d2phi_dxsi2[0][5] = -(9.0 * xsi2 * (3.0 * xsi2 - 1.0)) / 2.0;
        d2phi_dxsi2[0][6] = (9.0 * xsi2 * (6.0 * xsi2 + 6.0 * xsi1 - 5.0)) / 2.0;
        d2phi_dxsi2[0][7] = (9.0 * (3.0 * xsi2 * xsi2 + 12.0 * xsi1 * xsi2 - 5.0 * xsi2 + 9.0 * xsi1 * xsi1 - 10.0 * xsi1 + 2.0)) / 2.0;
        d2phi_dxsi2[0][8] = -(9.0 * (6.0 * xsi1 * xsi2 - xsi2 + 9.0 * xsi1 * xsi1 - 8.0 * xsi1 + 1.0)) / 2.0;
        d2phi_dxsi2[0][9] = -27.0 * xsi2 * (xsi2 + 2.0 * xsi1 - 1.0);

        d2phi_dxsi2[1][0] = 0.0;
        d2phi_dxsi2[1][1] = (27.0 * xsi2 * xsi2 - 18.0 * xsi2 + 2) / 2.0;
        d2phi_dxsi2[1][2] = -(27.0 * xsi2 * xsi2 + 54.0 * xsi1 * xsi2 - 36.0 * xsi2 + 27.0 * xsi1 * xsi1 - 36.0 * xsi1 + 11.0) / 2.0;
        d2phi_dxsi2[1][3] = (9.0 * xsi1 * (3.0 * xsi1 - 1.0)) / 2.0;
        d2phi_dxsi2[1][4] = (9.0 * xsi1 * (6.0 * xsi2 - 1.0)) / 2.0;
        d2phi_dxsi2[1][5] = -(9.0 * (9.0 * xsi2 * xsi2 + 6.0 * xsi1 * xsi2 - 8.0 * xsi2 - xsi1 + 1.0)) / 2.0;
        d2phi_dxsi2[1][6] = (9.0 * (9.0 * xsi2 * xsi2 + 12.0 * xsi1 * xsi2 - 10.0 * xsi2 + 3.0 * xsi1 * xsi1 - 5.0 * xsi1 + 2.0)) / 2.0;
        d2phi_dxsi2[1][7] = (9.0 * xsi1 * (6.0 * xsi2 + 6.0 * xsi1 - 5.0)) / 2.0;
        d2phi_dxsi2[1][8] = -(9.0 * xsi1 * (3.0 * xsi1 - 1.0)) / 2.0;
        d2phi_dxsi2[1][9] = -27.0 * xsi1 * (2.0 * xsi2 + xsi1 - 1.0);
        break;*/
    default:
        break;
    }
