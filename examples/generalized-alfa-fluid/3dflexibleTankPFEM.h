...
Point *p2   = fluid_geo->addPoint({L     , H    ,  0.0    });
Point *p3   = fluid_geo->addPoint({0.0   , H    ,  0.0    });
Point *p4   = fluid_geo->addPoint({1.5*L , 0.0  ,  0.0    });
Point *p5   = fluid_geo->addPoint({1.5*L , L    ,  0.0    });
Point *p6   = fluid_geo->addPoint({0.0   , L    ,  0.0    });
Point *p7   = fluid_geo->addPoint({0.0   , 0.0  ,  -t     });
Point *p8   = fluid_geo->addPoint({L     , 0.0  ,  -t     });
Point *p9   = fluid_geo->addPoint({L     , H    ,  -t     });
Point *p10  = fluid_geo->addPoint({0.0   , H    ,  -t     });
Point *p11  = fluid_geo->addPoint({1.5*L , 0.0  ,  -t     });
Point *p12  = fluid_geo->addPoint({1.5*L , L    ,  -t     });
Point *p13  = fluid_geo->addPoint({0.0   , L    ,  -t     });
Point *p14  = fluid_geo->addPoint({L     , 0    ,  -0.01*t });
Point *p15  = fluid_geo->addPoint({L     , 0    ,  -0.99*t });
Point *p16  = fluid_geo->addPoint({L     , H    ,  -0.99*t });
Point *p17  = fluid_geo->addPoint({L     , H    ,  -0.01*t });
Point *p18  = fluid_geo->addPoint({L     , L    ,  -0.99*t });
Point *p19  = fluid_geo->addPoint({L     , L    ,  -0.01*t });
...
fluid_geo->transfiniteSurface({s7}, "Right");
fluid_geo->transfiniteSurface({s8}, "Right");
...
fluid_problem->setAlpha(1.3);
fluid_problem->setMeshLength(h);

//Solid problem
Geometry *solid_geo = new Geometry(1);
Point *p20 = solid_geo->addPoint({L   , 0.0  ,  -0.01*t});
Point *p21 = solid_geo->addPoint({L+w , 0.0  ,  -0.01*t});
Point *p22 = solid_geo->addPoint({L+w , L    ,  -0.01*t});
Point *p23 = solid_geo->addPoint({L   , L    ,  -0.01*t});
Point *p24 = solid_geo->addPoint({L   , H    ,  -0.01*t});
Point *p25 = solid_geo->addPoint({L   , 0.0  , -0.99*t  });
Point *p26 = solid_geo->addPoint({L+w , 0.0  , -0.99*t  });
Point *p27 = solid_geo->addPoint({L+w , L    , -0.99*t  });
Point *p28 = solid_geo->addPoint({L   , L    , -0.99*t  });
Point *p29 = solid_geo->addPoint({L   , H    , -0.99*t  });
...
solid_geo->transfiniteSurface({s14}, "Right");
solid_geo->transfiniteSurface({s15}, "Right");
...
solid_problem->generateMesh(TET4, FRONT, "solid", "", true, false);
